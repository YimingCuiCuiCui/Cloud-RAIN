...
from utils.pct_util import SA_Layer

class PCT_semseg_s3dis(nn.Module):
    def __init__(self, args):
        super(PCT_semseg_s3dis, self).__init__()
        self.args = args
...
class PCT_semseg_scannet(nn.Module):
    def __init__(self, args):
        super(PCT_semseg_scannet, self).__init__()
        self.args = args
