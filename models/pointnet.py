...
import sys
sys.path.append("..")
from utils.pointnet_util import PointNetEncoder, feature_transform_reguliarzer, STNkd, STN3d
...
class PointNet_partseg(nn.Module):
    ...
    def forward(self, point_cloud, label):
        ...
        regular_loss = 0.001 * feature_transform_reguliarzer(trans_feat)
        return net, regular_loss

class PointNet_semseg_s3dis(nn.Module):
    def __init__(self, args, num_class=13):
        super(PointNet_semseg_s3dis, self).__init__()
        self.k = num_class
...
class PointNet_semseg_scannet(nn.Module):
    def __init__(self, args, num_class=21):
        super(PointNet_semseg_scannet, self).__init__()
        self.k = num_class
